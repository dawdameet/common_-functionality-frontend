...
export function CommunicationHub() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full border border-zinc-200 dark:border-zinc-900 rounded-3xl overflow-hidden bg-white dark:bg-zinc-950/50 backdrop-blur-sm shadow-sm dark:shadow-none">
      {/* Context Sidebar */}
      <div className="w-full md:w-80 h-48 md:h-auto shrink-0 border-b md:border-b-0 md:border-r border-zinc-200 dark:border-zinc-900 flex flex-col bg-zinc-50 dark:bg-zinc-950">
        <div className="p-4 md:p-6 border-b border-zinc-200 dark:border-zinc-900">
        ...
        <div className="flex-1 overflow-y-auto">
          {contexts.map((context) => (
            <button
              ...
              className={cn(
                "w-full p-3 md:p-4 flex flex-col gap-1 border-b border-zinc-200 dark:border-zinc-900/50 hover:bg-zinc-100 dark:hover:bg-zinc-900/50 transition-colors text-left",
      ...
      {/* Chat Area */}
      <div className="flex-1 flex flex-col bg-white dark:bg-zinc-900/10 min-h-0">
        <header className="p-4 md:p-6 border-b border-zinc-200 dark:border-zinc-900 flex justify-between items-center bg-zinc-50/50 dark:bg-zinc-950/50">
          <div>
            <h3 className="text-base md:text-lg font-medium text-zinc-900 dark:text-zinc-200">{activeContext.title}</h3>
        ...
        <div className="flex-1 p-4 md:p-8 overflow-y-auto space-y-6 md:space-y-8">
          {activeContext.type === "meeting" && (
            <div className="space-y-6">
              <div className="p-4 md:p-6 rounded-2xl bg-zinc-50 dark:bg-zinc-800/20 border border-zinc-200 dark:border-zinc-800/50">
          ...
          <div className="flex gap-4 max-w-2xl">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="p-3 md:p-4 rounded-2xl rounded-tl-none bg-zinc-100 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-300 text-sm">
        ...
        <div className="p-4 md:p-6 pt-0 mt-auto">
          <div className="relative">
            <input 
              ...
              className="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-full px-4 md:px-6 py-3 text-sm text-zinc-800 dark:text-zinc-300 focus:outline-none focus:border-zinc-400 dark:focus:border-zinc-700 transition-colors shadow-sm dark:shadow-none"
            />
