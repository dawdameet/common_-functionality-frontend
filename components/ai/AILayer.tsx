      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl border border-dashed border-zinc-300 dark:border-zinc-800 flex flex-col items-center justify-center text-center py-12">
              <Sparkles className="w-8 h-8 text-zinc-400 dark:text-zinc-700 mb-4" />
